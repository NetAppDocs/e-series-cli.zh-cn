...
link:../commands-a-z/set-storagearray-autosupportremotediag.html["启用或禁用AutoSupport远程诊断功能"]
...
link:../commands-a-z/save-storagearray-keymanagementcertificate.html["检索已安装的密钥管理CSR请求"]
